...
public class JackCompiler {
	...
	public static void compileFile(String jackFileName) throws IOException {
		...
		File vmFile = new File(jackFile.getParent() + "\\" + fileName + ".vm");
		CompilationEngine ce = new CompilationEngine(xxxT, vmFile);
		compile(ce);
		xxxT.delete(); // delete token file
	}
	...
	public static void compile(CompilationEngine ce) throws IOException {
		ce.compileClass();
	}
